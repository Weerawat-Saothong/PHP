        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="chartjs_bar" style="min-height: 450px; height: 250px; max-height: 450px; max-width: 100%;"></canvas>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="donutChart" style="min-height: 450px; height: 250px; max-height: 450px; max-width: 100%;"></canvas>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
...
<script>
  $(function () { 
    ...
    var donutData        = {
      ...
      datasets: [
        {
          data: <?php echo json_encode($cou); ?>,
          backgroundColor : ['#f39c12', '#00a65a', '#3c8dbc', '#7040fa', '#3c8dbc', '#d2d6de'],
        }
      ]
    }
    var donutOptions     = {
  ...
  var ctx = document.getElementById("chartjs_bar").getContext('2d');
    var myChart = new Chart(ctx, {
      type: 'bar',
      data: {
        label: 'แผนภูมิสรุประะดับการเฝ้าระวังสะสม',
        labels: <?php echo json_encode($types); ?>,
        datasets: [{
          backgroundColor: [
            "#ffc750",
      ...
      options: {
        legend: {
          ...
          labels: {
            fontColor: '#ff004e',
            fontFamily: 'แผนภูมิสรุประะดับการเฝ้าระวังสะสม',
            fontSize: 20,
          }
        },
